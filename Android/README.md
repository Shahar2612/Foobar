...
- **When running the server, if the MongoDB is empty, it will insert automatically the default posts and users. If there is any problem, you can find the posts.json, and users.json on the web repository in ./server**
- Notice that for now, you can find the Web client and the server in a different [repository](https://github.com/Shahar2612/ProjectPart2-Web.git).
